...
public class fVentInteraction : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (playerRaycast.isfVentObj && Vector3.Distance(player.transform.position, this.transform.position) < playerManager.pickupDist)
        {
